...
import 'package:medapp/add_new_medicine/form_fields.dart';
import 'package:medapp/add_new_medicine/medicine_type_card.dart';
import 'package:medapp/database/repository.dart';
import 'package:medapp/helpers/platform_flat_button.dart';
import 'package:medapp/helpers/snack_bar.dart';
...
class _AddNewMedicineState extends State<AddNewMedicine> {
                        ...
                        child: PlatformFlatButton(
                          ...
                          buttonChild: Row(
                            ...
                            children: [
                              ...
                              Text(
                                '${setDate.hour.toString().padLeft(2, '0')}:${setDate.minute.toString().padLeft(2, '0')}',
  ...
  int get time {
    ...
    final setTime = setDate;

    return setTime.millisecondsSinceEpoch -
