...
class MedicineCard extends StatelessWidget {
    ...
    return Card(
        ...
        child: ListTile(
            ...
            trailing: Column(
              ...
              children: [
                Text(
                  '${DateTime.fromMillisecondsSinceEpoch(medicine.time).hour.toString().padLeft(2, '0')}:${DateTime.fromMillisecondsSinceEpoch(medicine.time).minute.toString().padLeft(2, '0')}',
                  style: TextStyle(
  ...
  void _showDeleteDialog(BuildContext context, String medicineName,
      String? medicineId, int notifyId) {
    showDialog(
        context: context,
